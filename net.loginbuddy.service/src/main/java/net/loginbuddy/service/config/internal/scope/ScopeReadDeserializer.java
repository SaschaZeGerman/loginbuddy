...
public class ScopeReadDeserializer extends JsonDeserializer<Read> {

    @Override
    public Read deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
        ObjectCodec oc = jp.getCodec();
        JsonNode node = oc.readTree(jp);
        Read parent = new Read();
