...
public class Registration extends Overlord {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    if (!issuerResult.getResult().equals(RESULT.VALID)) {
      ...
      response.getWriter()
          .write(getErrorAsJson("invalid_request", "Missing or invalid or multiple issuer parameters given").toJSONString());
      return;
    }
    ...
    JSONObject registration = retrieveAndRegister(issuerResult.getValue(), discoveryUrl);
