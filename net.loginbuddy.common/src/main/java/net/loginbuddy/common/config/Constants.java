...
public enum Constants {
    ...
    SIDECAR_AUTHORIZATION_REQUEST_ENDPOINT("sidecar_authorization_request_endpoint"),
    NONCE("nonce"),
    ...
    SESSION("session"),
    SIDECAR_CLIENT_ID("loginbuddy-sidecar"),
    SIDECAR_REDIRECT_URI("http://localhost/?"),
    SCOPE("scope"),
    ...
    CLIENT_AUTHORIZATION_DETAILS("clientAuthorizationDetails"),
