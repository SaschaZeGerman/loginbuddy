...
<div class="container" id="content">
    ...
    <ol>
        ...
        <li><strong>state *: </strong>An opaque value for loginbuddy, but required by the client to match sessions, keep them aligned</li>
    ...
    <form action="initialize" method="post" enctype="application/x-www-form-urlencoded">
        <div class="form-group">
            ...
            <input type="text" id="client_id" name="client_id" size="80" class="form-control" value="clientIdForTestingPurposes">
        </div>
        <div class="form-group">
